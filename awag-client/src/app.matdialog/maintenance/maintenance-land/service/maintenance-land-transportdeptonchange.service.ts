 ...
 */
@Injectable()
export class MaintenanceLandTransportdeptOnChangeService extends AwagBaseService {
  ...
  execute(param: any): Observable<any> {
    this.awagLogger.debug('MaintenanceLandTransportdeptOnChangeService.execute()');
