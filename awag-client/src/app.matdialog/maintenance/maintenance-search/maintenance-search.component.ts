...
export class MaintenanceSearchComponent extends AwagBaseComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  awagSelect(index: number, item: any) {
    ...
    this.model.search['detailEto'] ='乙亥';
    ...
    this.model.search['otherAddress'] = item.homeadd;
    ...
    forkJoin({
        contractno: this.contractnoService.getConctractnoByCustomerNo(item.customerno),
        card: this.contractListService.getCardByCustomerNo(item.customerno),
        capu1: this.contractListService.getCapu1ByCustomerNo(item.customerno),
        capu2: this.contractListService.getCapu2ByCustomerNo(item.customerno),
        senso: this.contractListService.getSensoByCustomerNo(item.customerno),
        yoshin: this.contractListService.getYoshinByCustomerNo(item.customerno),
      }).subscribe({
        next: (result) => {
